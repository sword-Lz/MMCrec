...
class Gmclrec(SequentialModel):
    ...
    def parse_model_args(parser):
        ...
        parser.add_argument('--lmd', type=float, default=0.03, help='weight for L1')
    ...
    def __init__(self, args, corpus):
        ...
        self.graph = self.make_torch_adj(iigraph).to_dense()
    ...
    def forward(self, feed_dict):
        ...
        if feed_dict['phase'] == 'train':
            ...
            aug1_his_vectors = adj[aug1_history]
            aug2_his_vectors = adj[aug2_history]
